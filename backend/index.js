...
const options = {
  key: fs.readFileSync('./SecureKeys/letsencrypt/live/algou.projectsbyutkarsh.tech/privkey.pem'),
  cert: fs.readFileSync('./SecureKeys/letsencrypt/live/algou.projectsbyutkarsh.tech/cert.pem'),
  ca: fs.readFileSync('./SecureKeys/letsencrypt/live/algou.projectsbyutkarsh.tech/chain.pem'),
};
